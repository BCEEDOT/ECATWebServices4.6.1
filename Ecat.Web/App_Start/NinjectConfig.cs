...
namespace Ecat.Web
{
    public static class NinjectConfig
    {
        public static IKernel GetKernal()
        {
            ...
            kernel.Bind<EFContextProvider<UserMetadataCtx>>().ToSelf().InRequestScope();
            kernel.Bind<EFContextProvider<StudMetadataCtx>>().ToSelf().InRequestScope();
            kernel.Bind<EFContextProvider<FacMetadataCtx>>().ToSelf().InRequestScope();
            ...
            kernel.Bind<BbWsCnet>().ToSelf().InRequestScope();
